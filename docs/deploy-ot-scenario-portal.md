...
4. In the left sidebar of the portal, navigate to **Sandboxes** > **Definitions**.
...
7. Click **Save**.
8. Once imported, the portal will automatically validate the YAML syntax. Click on the definition name to view the visual graph representation of your networks (`mgmt-net`, `ot-net`) and hosts (`attacker-host`, `scada-hmi`, `openplc-node`, `ot-router`).
